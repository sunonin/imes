...
{ 
    ...
    {
        $qry = "INSERT INTO tblassessment_links SET comp_id =:comp_id, date_created =:created_at";
    ...
    {
        $qry = "UPDATE tblassessment_links SET is_done =:is_done, updated_at =:updated_at WHERE id =:id";
