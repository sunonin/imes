...
{ 
    ...
    {
        $qry = "UPDATE tblprofile SET lname =:lname, fname =:fname, mname =:mname, extn_name =:extn_name, birth_date =:birth_date, exact_address =:exact_address, email =:email, mobile =:mobile, gender =:gender, province =:province, citymun =:citymun, updated_at =:updated_at WHERE id =:id";
