...
if ($method == 'POST') {
	...
	$overview->setSid($sid);
	$overview->setTypeId(StudentOverview::TYPE_PREOJT);
	...
	$notif->setMessage('Successfully evaluated Pre-OJT Requirements.');
	...
	header('location:../student_pre_ojtreq.php?id='.$overview->sid.'&pr');
} else {
