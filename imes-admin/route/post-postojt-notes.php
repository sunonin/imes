...
require_once '../model/StudentPostOjtRequirements.php';
...
if ($method == 'POST') {
	...
	header('location:../student-post-ojt.php?id='.$preojt->student_id.'&pr');
} else {
