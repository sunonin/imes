...
class PreOjtRequirements extends Connection 
{ 
	// tblstudent_preojt
    private $conn = '';
    public $student_id = '';
    ...
    {
        $qry = "INSERT INTO tblstudent_preojt SET student_id =:student_id, type_id =:type_id, filename =:filename, date_accomplished =:date_accomplished";
    ...
    {
        $qry = "DELETE FROM tblstudent_preojt WHERE tblstudent_preojt.student_id =:student_id AND tblstudent_preojt.type_id =:type_id";
        $stmt = $this->conn->prepare($qry);
    ...
    public function find()
    {
        $qry = "SELECT *
                ...
                WHERE tblstudent_preojt.student_id =:student_id AND tblstudent_preojt.type_id =:type_id AND tblstudent_preojt.status = 21";
        $stmt = $this->conn->prepare($qry);
    ...
    {
        $qry = "SELECT * FROM tblstudent_preojt WHERE tblstudent_preojt.student_id =:student_id AND tblstudent_preojt.type_id =:type_id";
        $stmt = $this->conn->prepare($qry);
